...
[The latest release is `v0.10.1`](https://github.com/jchesterpivotal/concourse-build-resource/releases/tag/v0.10.1). See [the release README](https://github.com/jchesterpivotal/concourse-build-resource/tree/v0.10.1/README.md)
...
- name: concourse-build
  ...
  source:
    ...
    tag: v0.10.1 # check https://github.com/jchesterpivotal/concourse-build-resource/releases
